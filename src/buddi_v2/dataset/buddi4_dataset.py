...
def get_supervised_dataset(
    ...
    :param stim_known_prop: numpy array of one hot encoded stimulation labels of shape (n, num_unique_stimulations)
...
def get_unsupervised_dataset(
    ...
    :param stim_unknown_prop: numpy array of one hot encoded stimulation labels of shape (n, num_unique_stimulations)
